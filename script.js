...
const addTodo = () => {
    ...
    showTable()
    showToast("Your task has been successfully added.", "success", "green")
...
const handleDelete = (item) => {
    ...
    showTable()
    showToast("Your task has been successfully deleted.", "success", "green",)
}
...
const handleUpdate = (id) => {
    ...
    document.getElementById("updateBtn").onclick = function () {
        ...
        showTable()
        showToast("Your task has been successfully Updated.", "success",)
        document.getElementById("title").value = ""
...
const showTable = () => {
    ...
    let mainTable = todos.map((item) => {
        ...
        <button onclick="handleDelete(${item.id})" class="btn mt-2 btn-danger"><i class='fa fa-trash' style="font-size:20px"></i></button>
        </td>
        </tr>`
    })
